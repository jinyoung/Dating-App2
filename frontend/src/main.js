...
pluralCaseList.push( {plural: "profiles", pascal: "Profile"} )

pluralCaseList.push( {plural: "matches", pascal: "Match"} )

pluralCaseList.push( {plural: "chats", pascal: "Chat"} )
pluralCaseList.push( {plural: "socialFeeds", pascal: "SocialFeed"} )
