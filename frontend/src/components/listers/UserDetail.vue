<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="Occupation" v-model="item.occupation" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="DatingAppPreference" v-model="item.datingAppPreference" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
