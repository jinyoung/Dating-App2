<template>
    ...
    <v-card style="width:450px;" outlined color="surface">
        ...
        <v-card-text>
            ...
            <String label="Occupation" v-model="value.occupation" :editMode="editMode"/>
            <String label="DatingAppPreference" v-model="value.datingAppPreference" :editMode="editMode"/>
        </v-card-text>
